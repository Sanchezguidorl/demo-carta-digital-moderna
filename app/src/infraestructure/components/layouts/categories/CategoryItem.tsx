...
function CategoryItem({categoryItemProps}:{categoryItemProps:CategoryItemType}) {
  return (
    <li className='w-full text-shadow' id='CardItem'>
        <Link className=" overflow-hidden relative flex justify-center items-center h-[110px] sm:h-[200px] md:h-[240px] uppercase brightness-90 hover:brightness-125" href={"/pages/platos"}>
        <Image
